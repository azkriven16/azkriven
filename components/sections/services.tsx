                        ...
                        <div className="space-y-6 lg:space-y-10">
                            ...
                            <div className="flex">
                                ...
                                <div className="ms-5 sm:ms-8">
                                    ...
                                    <p className="mt-1 text-muted-foreground">
                                        We choose our teams carefully. Our
                                        people are the secret to great work.
                                    </p>
                                </div>
                            </div>
                            {/* End Icon Block */}
                            ...
                            <div className="flex">
                                ...
                                <div className="ms-5 sm:ms-8">
                                    ...
                                    <p className="mt-1 text-muted-foreground">
                                        Benefit from automatic updates to all
                                        boards any time you need to make a
                            ...
                            <div className="flex">
                                ...
                                <div className="ms-5 sm:ms-8">
                                    ...
                                    <p className="mt-1 text-muted-foreground">
                                        We&apos;ve user tested our own process
                                        by shipping over 1k products for
                                        clients.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="space-y-6 lg:space-y-10">
                            ...
                            <div className="flex">
                                ...
                                <div className="ms-5 sm:ms-8">
                                    ...
                                    <p className="mt-1 text-muted-foreground">
                                        We stay lean and help your product do
                                        one thing well.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex">
                                ...
                                <div className="ms-5 sm:ms-8">
                                    ...
                                    <p className="mt-1 text-muted-foreground">
                                        We actively pursue the right balance
